...
const ClientTestimoni = ({ clientSay, name, from }) => {
  return (
    <div className="bg-gray-testimoni font-primary px-6 py-5 mt-8 rounded-lg lg:rounded-2xl xl:mt-50px md:px-50px  lg:py-10 lg:w-7/12 ">
      <Image
        alt="Double Quote Icons"
        className="w-9 h-9 lg:w-10 lg:h-10"
        src={quoteIcon}
      />
      <p className=" text-sm mt-5 lg:text-lg  lg:mt-30px text-justify">
        {clientSay}
      </p>
      <div className="client-identity flex flex-col justify-end  items-end text-sm">
